...
def home():
    ...
    last_save_time = datetime.strptime(utils[state_idx]["LastStateSaveTime"], "%Y-%m-%d %H:%M:%S").astimezone(local_tz)

    pump_start_time = None
    if utils[state_idx]["IsDeviceRunning"]:
        pump_start_time = datetime.strptime(utils[state_idx]["DeviceLastStartTime"], "%Y-%m-%d %H:%M:%S").astimezone(local_tz)
