"""Flask application to serve a simple web page."""
import os
from flask import Flask, request, send_from_directory
from views import views, register_utility_func
...
def handle_exception(e):
    ...
    error_message = utility_funcs.report_fatal_error(f"An error occurred: {str(e)}", report_stack=True)
